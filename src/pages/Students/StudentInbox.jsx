...
function StudentInbox() {
    ...
    const fetchMessages = async (studentID) => {
        try {
            const response = await server.get(`/api/student/get-student-inbox-messages/?studentID=${studentID}`);
            ...
            >
                ...
                <Tabs.Root defaultValue="All" colorPalette={"blue"}>
                    ...
                    <Tabs.Content value="All">
                        {inboxMessages.map((message) => <NotificationRow key={message.id} message={message} />)}
                    </Tabs.Content>
                </Tabs.Root>
            </motion.div>
        )
